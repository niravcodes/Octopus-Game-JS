...
import { vortex, vortexFG } from "../characters/vortex.js";

import Character from "../../library/character.js";
import { Kinetics } from "../../library/kinetics.js";
import SimpleText from "../../library/SimpleText.js";
import { StaticText } from "../../library/StaticRenderables.js";
...
level1.startingCondition = function () {
  ...
  let line3 = new StaticText(
    "Keep running. Maybe you'll find something ...",
    (3 * cw) / 2,
    340,
    "Economica",
    "#ff6a4f",
